    ...
    <section style={{
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: isMobile ? 36 : 52 }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: '#ffffff', border: '1px solid #e8eaed', padding: '7px 16px', borderRadius: 20, marginBottom: 28, boxShadow: '0 1px 2px rgba(60,64,67,0.3)', flexWrap: 'wrap' as const, justifyContent: 'center' }}>
          ...
          <h1 style={{ fontSize: 'clamp(30px, 6vw, 56px)', fontWeight: 800, lineHeight: 1.1, letterSpacing: -2, margin: '0 auto 22px', color: '#202124' }}>
          ...
          <p style={{ fontSize: isMobile ? 16 : 18, color: '#3c4043', maxWidth: 560, margin: '0 auto', lineHeight: 1.75 }}>
        ...
        <div style={{ textAlign: 'center', marginTop: isMobile ? 32 : 48 }}>
          <div style={{ marginBottom: 24 }}>
            <a href="#contact" style={{ display: 'inline-block', padding: isMobile ? '14px 28px' : '17px 38px', borderRadius: 10, background: '#16a34a', color: '#ffffff', fontSize: isMobile ? 15 : 16, fontWeight: 600, textDecoration: 'none', boxShadow: '0 2px 8px rgba(22,163,74,0.3)' }}>
